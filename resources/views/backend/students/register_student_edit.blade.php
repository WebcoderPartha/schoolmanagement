            ...
            <div class="card-body">
                <form method="POST" action="{{ route('student.regi.update', $student->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $discount->discount_percentage }}" class="form-control" name="discount_percentage" id="discount_percentage" placeholder="Discount percentage">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <img src="{{ (!empty($assignStudent->student->image))?  asset($assignStudent->student->image) :'' }}" width="150" id="showImage" alt="">
                            </div>
                        </div>
                    </div> <!-- End Row -->
                    <div class="row mt-4">
