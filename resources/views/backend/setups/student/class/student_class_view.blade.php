                                    ...
                                    @foreach($studentClasses as $key => $studentClass)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('student.class.edit', $studentClass->id) }}" type="button" class="btn btn-warning btn-icon-text">
                                                    <i class="typcn typcn-edit btn-icon-prepend"></i>
                                                    Edit
                                                </a>
                                                <a id="delete" href="{{ route('student.class.delete', $studentClass->id) }}" type="button" class="btn btn-danger btn-icon-text">
