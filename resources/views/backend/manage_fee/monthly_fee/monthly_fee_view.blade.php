                                    ...
                                    @foreach($years as $key => $year)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a target="_blank" href="{{ route('monthly.fee.wise.pdf',['student_year_id'=>$year->student_year_id, 'month_id' => $year->month_id]) }}" class="btn btn-sm btn-primary btn-icon-text">
                                                    Print
